    ...
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
      <Panel title="登记每日营业额">
        <form className="space-y-5" onSubmit={onSubmit}>
          ...
          <div className="rounded-card border border-brand-100/70 bg-brand-50/55 p-4 text-sm font-semibold text-brand-900"><ArrowRightLeft size={16} className="mr-2 inline" />1 PV = ¥12.5</div>
      ...
      <Panel title="换算规则" className="bg-gradient-to-br from-white via-blue-50/20 to-brand-50/25"><p className="text-3xl font-black tabular-nums text-ink">1 PV = ¥12.5</p><p className="mt-3 text-sm leading-6 text-ink-muted">营业额是业务指标，不等于真实现金收入。编辑任一字段时，另一字段会立即更新。</p></Panel>
    </div>
