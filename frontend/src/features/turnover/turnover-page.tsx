...
function fromTurnover(value: Turnover): TurnoverForm { return { turnover_date: value.turnover_date, pv: value.pv, net_amount: value.net_amount, note: value.note ?? "" }; }
...
export function TurnoverPage({ authResponse }: { authResponse: AuthResponse }) {
  ...
  const onSubmit = form.handleSubmit((value) => mutation.mutate({ turnover_date: value.turnover_date, pv: value.pv ?? null, net_amount: value.net_amount ?? null, note: value.note.trim() || null }));
