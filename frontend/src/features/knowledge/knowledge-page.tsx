...
export function KnowledgePage({ authResponse }: { authResponse: AuthResponse }) {
  ...
  return <div className="knowledge-page space-y-6">
    <PageHeader eyebrow="输入与沉淀" title="学习中心" description="管理学习项目、真实学习投入与安全存储的附件。" />
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex justify-end"><Button onClick={() => setEditorOpen(true)}><Plus size={16} />新增学习</Button></div>
    </div>
