...
export function AnalyticsPage({ authResponse }: { authResponse: AuthResponse }) {
  ...
  return <div className="space-y-6">
    ...
    <div data-testid="analytics-range-toolbar" className="grid min-h-[76px] items-center gap-3 rounded-lg border border-slate-200 bg-white p-3 lg:h-[88px] lg:grid-cols-[auto_minmax(320px,1fr)_auto]">
